...
<div class="container-fluid py-2">
    <div class="row align-items-center">
        ...
        <div class="col-md-8 text-end mt-3 ">
            <a href="{{ route('category.create') }}" class="btn btn-primary" style="background-color: #E63572; border-color: #E63572; margin-right : 2.5% ;font-size: 15px;">Add Category</a>
        </div>
    </div>
</div>
                            ...
                            <tbody>
                                ...
                                <tr style="padding: 15px 0;">
                                    <td class="text-center">
                                        <p class="text-md font-weight-bold mb-0">{{ $category->id }}</p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-md font-weight-bold mb-0">{{ $category->category_name }}</p>
                                    </td>
                                    <td class="align-middle text-center" style="padding-top: 10px; padding-bottom: 10px;">

                                        <a href="{{ route('category.edit', $category->id) }}" class="btn btn-edit text-md" data-toggle="tooltip" data-original-title="Edit price_categorys">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <form action="{{ route('category.destroy', $category->id) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
                                            <a href="javascript:;" class="btn btn-delete text-md" data-toggle="tooltip" data-original-title="Delete category"
